...
For the point of view of partitions, the returned list is the preimage of the epimorphism associated with the partition, where the preimage is defined as the indexed set of the fibers of the epimorphism.
...
def _preimage_of_partition(partition):
  ...
  epimorphism = _epi_factorizes_partition(partition)
