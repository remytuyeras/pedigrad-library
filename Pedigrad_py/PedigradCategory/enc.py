#------------------------------------------------------------------------------
#_epi_normalize_column(column,exceptions): list
#------------------------------------------------------------------------------
'''
This function refines the procedure _epi_factorize_partition by relabeling the elements of a list with canonical labels except for those elements that can be found in a second input list. In other words, it takes two input lists and returns one. 
...
e.g. 
_epi_normalize_column(['A','4','C','C','a','A'],['4']) = [0, '4', 2, 2, 3, 0]
...
def _epi_normalize_column(column,exceptions):
